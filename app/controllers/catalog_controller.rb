class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_index_field solr_name("creator_of_work", :stored_searchable), label: "maker_facet", itemprop: 'creator_of_work', link_to_search: solr_name("maker_facet", :facetable)
    ...
    config.add_index_field solr_name("printer_of_plates", :stored_searchable), label: "Printer_of_plates", itemprop: 'printer_of_plates', link_to_search: solr_name("maker_facet", :facetable)
