...
var source = "<li class=\"field-wrapper input-group input-append\">" +
  ...
  "<div class=\"row\">  <div class=\"col-md-2\"><label for=\"generic_file_{{name}}_attributes_{{index}}_finish\">Finish</label>  </div>" +
    ...
    "<div class=\"col-md-3\"><select name=\"generic_file[{{name}}_attributes][{{index}}][finish_qualifier]\" id=\"generic_file_{{name}}_attributes_{{index}}_finish_qualifier\" label=\"\" class=\"select form-control\"><option value=\"\"></option><option value=\"before\">before</option> <option value=\"circa\">circa</option></select>  </div></div>" +
  "<div class=\"row\">  <div class=\"col-md-2\"><label for=\"generic_file_{{name}}_attributes_{{index}}_label\">Label</label>  </div>  <div class=\"col-md-7\"><input class=\"string multi_value optional form-control generic_file_{{name}} form-control multi-text-field\" name=\"generic_file[{{name}}_attributes][{{index}}][label]\" id=\"generic_file_{{name}}_attributes_{{index}}_hidden_label\" aria-labelledby=\"generic_file_{{name}}_label\" type=\"text\">  </div></div>" +
  "<div class=\"row\">  <div class=\"col-md-2\"><label for=\"generic_file_{{name}}_attributes_{{index}}_note\">Note</label>  </div>  <div class=\"col-md-7\"><input class=\"string multi_value optional form-control generic_file_{{name}} form-control multi-text-field\" name=\"generic_file[{{name}}_attributes][{{index}}][note]\" id=\"generic_file_{{name}}_attributes_{{index}}_hidden_label\" aria-labelledby=\"generic_file_{{name}}_label\" type=\"text\">  </div>" +
    "<div class=\"col-md-3\">" +
