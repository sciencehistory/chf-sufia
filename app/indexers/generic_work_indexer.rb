class GenericWorkIndexer < CurationConcerns::WorkIndexer
  ...
  def generate_solr_document
    super.tap do |doc|
      ...
      makers = %w(after artist author addressee creator_of_work contributor engraver interviewee interviewer manufacturer photographer printer_of_plates publisher)
